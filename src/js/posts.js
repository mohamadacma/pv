...
const blogPosts = [
    {
        ...
        date: "2024-11-06",
        time: "12:00",
        preview: "If we go back to the 17th and 18th century, the majority of the discourse at the time was expository, rational, long-form and sequential...",
        content: `If we go back to the 17th and 18th century, the nature of the discourse at the time was expository, rational, long-form and sequential. People had a typographic mind; the only medium of communication available was the printed word, so people had to read and think and engage actively with the medium which, in turn, made them more thoughtful, critical, and inclined to engage in the expositional form of discourse. People wouldn't have minded listening to a debate for 7 hours. Debates and discussions were serious at the time.

As we can see, the medium is not merely a message, the medium is the metaphor, the metaphor for something else, for shaping a culture, for changing behaviors. It is akin to a clock; we've invented a clock as a metaphor for controlling infinity, making fun of it; similarly, sunglasses that aid in seeing were a metaphor for rebellion against nature: we don't need to succumb to nature, we can change it. Oratory discourse, aka the rise of the typographic mind thanks to the printing press, marked the apogee of seriousness and critical thought. The ratio of information to action was super high, the "news" was relevant, the truth was reachable through long-form discourse, everything you heard was contained in a context familiar to your model of the world.

Then came the telegraph, an instantaneous transfer of information over space. The information suddenly becomes irrelevant, the problems of the world suddenly become your problem, the decontextualization arrived, the relevance started to fade in the back of a sea of irrelevance. The medium of the telegraph was encroaching on the clearness of a typographic mind. Fast forward and the TV arrives, and that's when things start to go haywire and the typographic mind dwindles. The promise of the TV was to turn everything into entertainment: Religion, Politics, News, Education. Suddenly everything had to conform to what the medium of TV required: make things that are appealing to a wide audience, short-form and entertaining, and switch between widely different topics using the Now....then method of TV. Irrelevance had suddenly become an ocean, and context was erased. The goal was to keep you watching.

Orwell was scared of a world where books are banned, information is restricted, and truth is concealed, but it turns out the world we ended up in is a Huxleyan world: no need to ban books, restrict information, or censor the truth. Just make the truth hard to get to; drown it in a sea of irrelevance and make things entertaining.

You can extend Neil Postman's worries to the 21st century, and think of the mediums of nowadays: TikTok, X, Instagram... How are these mediums shaping the culture of the day? What are they a metaphor for? I think it is clear that we're still living in that Huxleyan world of scrolling ourselves to death and entertaining ourselves with the illusion of knowledge with what is merely sound-bites of a decontextualized sea of irrelevance that is disguising itself as relevant and worthy.

This book has reminded me to revive my typographical mind and seek long-form writing because the habits of mind that these mediums are imposing on us are ones that encourage rage, delusions, and atrophy of our critical faculties. Do you think X can ever be a medium where the next Iliad will be produced? Or like Instagram the next education frontier? The medium is the metaphor!`,
